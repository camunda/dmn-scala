...
class DmnScalaTransformer(dmnEngine: CamundaDmnEngine) extends DmnTransformer {
  ...
  override def setTransformListeners(
      transformListeners: JList[DmnTransformListener]) =
    throw new UnsupportedOperationException

  override def transformListeners(
      transformListeners: JList[DmnTransformListener]) =
    throw new UnsupportedOperationException

  override def getElementTransformHandlerRegistry =
    throw new UnsupportedOperationException

  override def setElementTransformHandlerRegistry(
      registry: DmnElementTransformHandlerRegistry) =
    throw new UnsupportedOperationException

  override def elementTransformHandlerRegistry(
      registry: DmnElementTransformHandlerRegistry) =
    throw new UnsupportedOperationException

  override def getDataTypeTransformerRegistry =
    throw new UnsupportedOperationException

  override def setDataTypeTransformerRegistry(
      registry: DmnDataTypeTransformerRegistry) =
    throw new UnsupportedOperationException

  override def dataTypeTransformerRegistry(
      registry: DmnDataTypeTransformerRegistry) =
    throw new UnsupportedOperationException

  override def getHitPolicyHandlerRegistry =
    throw new UnsupportedOperationException

  override def setHitPolicyHandlerRegistry(
      registry: DmnHitPolicyHandlerRegistry) =
    throw new UnsupportedOperationException

  override def hitPolicyHandlerRegistry(registry: DmnHitPolicyHandlerRegistry) =
    throw new UnsupportedOperationException
